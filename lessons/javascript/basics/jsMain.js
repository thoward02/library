//Controls the main menu for js lessons
...
function main(){
  ...
  var lesson1 = ['Basics', 'jsBasics.html']
  var lesson2 = ['Editing Html', 'editingHtml.html']
  var lesson3 = ['Functions', 'jsFunctions.js']
  var lesson4 = ['Loops', 'jsLoops.html']
